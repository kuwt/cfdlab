...
double Discretization::convection_u(const Matrix<double> &U, const Matrix<double> &V, int i, int j) {}//TODO:

double Discretization::convection_v(const Matrix<double> &U, const Matrix<double> &V, int i, int j) {}//TODO:

double Discretization::diffusion(const Matrix<double> &A, int i, int j) {}//TODO:
